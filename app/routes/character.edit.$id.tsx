...
export default function EditCharacter() {
    ...
    return (
        <div className="m-auto md:w-1/2 w-3/4 py-14">
            <h1 className="font-bold text-3xl text-center">{data.name}のキャラクター情報を編集</h1>
            ...
            <Form method="post" className="py-10">
                ...
                <div>
                    ...
                    <Input type="text" name="name" id="name" defaultValue={data.name} required />
                </div>
                <div>
                    <label htmlFor="model_url">モデルURL</label>
                    <Input type="text" name="model_url" id="model_url" pattern="https?://\S+" title="URLは、httpsで始まる絶対URLで記入してください。" defaultValue={data.model_url} required />
                </div>
                <div>
                ...
                <div>
                    ...
                    <Input type="text" name="firstperson" id="firstperson" defaultValue={data.firstperson} required />
                </div>
                <div>
                    <label htmlFor="ending">語尾</label>
                    <Input type="text" name="ending" id="ending" defaultValue={data.ending} />
                </div>
                <div>
